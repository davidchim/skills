...
| Skill | Description |
|-------|-------------|
| [1688-product-detail](ecommerce/1688-product-detail) | Extract full wholesale product data (pricing tiers, SKUs, seller info) from 1688.com detail pages |
| [airbnb-listing-detail](ecommerce/airbnb-listing-detail) | Fetch complete Airbnb listing details (amenities, photos, rules, ratings) by listing ID via GraphQL |
| [airbnb-search-listing](ecommerce/airbnb-search-listing) | Scrape Airbnb accommodation search results (price, rating, coordinates) with pagination |
...
| [amazon-bestseller-listing](ecommerce/amazon-bestseller-listing) | Scrape Amazon Best Sellers charts (rank, ASIN, price, rating) across all regional TLDs |
...
| [amazon-product-detail](ecommerce/amazon-product-detail) | Extract full Amazon product data from any /dp/ page across all regional TLDs |
...
| [amazon-search-listing](ecommerce/amazon-search-listing) | Scrape Amazon search/category listings with per-item cards and pagination |
| [ebay-item-detail](ecommerce/ebay-item-detail) | Extract full eBay item detail (specifics, seller, condition) from any item URL |
| [ebay-search-listing](ecommerce/ebay-search-listing) | Scrape eBay search/category listings with per-item cards and pagination |
| [ebay-sold-listings-search](ecommerce/ebay-sold-listings-search) | Scrape eBay sold/completed listings with real sale prices across 8 marketplaces |
...
| [etsy-category-listing](ecommerce/etsy-category-listing) | Scrape paginated Etsy category-page product listings |
| [etsy-keyword-search](ecommerce/etsy-keyword-search) | Scrape paginated Etsy keyword-search product listings |
| [etsy-product-detail](ecommerce/etsy-product-detail) | Extract full Etsy listing detail (price, variations, images, favorites) |
| [etsy-shop-catalog](ecommerce/etsy-shop-catalog) | Scrape a full Etsy shop's storefront catalog with pagination |
...
| [walmart-category-listing](ecommerce/walmart-category-listing) | Scrape paginated Walmart category/browse product listings |
| [walmart-keyword-search](ecommerce/walmart-keyword-search) | Scrape paginated Walmart keyword-search product listings |
| [walmart-product-detail](ecommerce/walmart-product-detail) | Extract full Walmart product data (specs, variants, fulfillment) from item URL |
| [walmart-product-reviews](ecommerce/walmart-product-reviews) | Scrape paginated Walmart customer reviews by item ID |
...
| [producthunt-launches](lead-generation/producthunt-launches) | Scrape Product Hunt leaderboard launches with maker profiles and contact info |
...
| [trustpilot-company-info](lead-generation/trustpilot-company-info) | Look up Trustpilot company profile and TrustScore by domain |
...
| [webcrawler-deep-crawl](search-research/webcrawler-deep-crawl) | Deep-crawl any site into LLM-ready markdown/text with metadata |
...
| [threads-keyword-search](social-listening/threads-keyword-search) | Search Threads posts by keyword/hashtag with engagement metrics |
| [threads-profile-search](social-listening/threads-profile-search) | Discover Threads user accounts by keyword |
| [threads-user-posts](social-listening/threads-user-posts) | Fetch public posts from a Threads user's profile |
...
| [trustpilot-reviews](social-listening/trustpilot-reviews) | Scrape paginated Trustpilot customer reviews with rich filters |
...
| [xiaohongshu-search-full](social-listening/xiaohongshu-search-full) | Search Xiaohongshu/RedNote notes by keyword with full field extraction |
...
| Skill | Description |
|-------|-------------|
| [douyin-video-search](video-platforms/douyin-video-search) | Search Douyin videos by keyword with stats and download URLs |
